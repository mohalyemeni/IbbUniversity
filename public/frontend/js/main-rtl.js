...
(function ($) {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        const toggleElement = document.querySelector(".mobile-toggle");
        const toggleContent = document.querySelector(".mobile-toggle-content");
        const toggleIcon = toggleElement.querySelector(".toggle-icon");

        if (
            !toggleIcon.classList.contains("plus") &&
            !toggleIcon.classList.contains("minus")
        ) {
        ...
        const submenuItems = document.querySelectorAll(
            ".widget-archives ul li.has-submenu"
        );
        ...
        submenuItems.forEach((item) => {
            ...
            if (
                icon &&
                !icon.classList.contains("plus") &&
                !icon.classList.contains("minus")
            ) {
