...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Advertisor sliders
        $manageMediaContents = Permission::create(['name' => 'manage_media_contents', 'display_name' => ['ar'    =>  'إدارة الإعلام والمحتوى', 'en'   =>  'Media Contents'], 'route' => 'media_contents', 'module' => 'media_contents', 'as' => 'news.index', 'icon' => 'fas fa-bullhorn', 'parent' => 0, 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '80',]);
        $manageMediaContents->parent_show = $manageMediaContents->id;
        $manageMediaContents->save();

        // news
        $manageNews = Permission::create(['name' => 'manage_news', 'display_name' => ['ar'  =>  'إدارة الاخبار',    'en'    =>  'Manage News'], 'route' => 'news', 'module' => 'news', 'as' => 'news.index', 'icon' => 'fas fas fa-newspaper', 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '70',]);
        $manageNews->parent_show = $manageMediaContents->id;
        $manageNews->save();
        $showNews   =  Permission::create(['name'  => 'show_news', 'display_name'       =>  ['ar'   =>  'الاخبار',   'en'    =>  'News'], 'route' => 'news', 'module' => 'news', 'as' => 'news.index', 'icon' => 'fas fas fa-newspaper', 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'parent_show' => $manageMediaContents->id, 'sidebar_link' => '0', 'appear' => '0']);
        $createNews =  Permission::create(['name'  => 'create_news', 'display_name'     =>  ['ar'   =>  'إنشاء خبر',   'en'    =>  'Create News'], 'route' => 'news', 'module' => 'news', 'as' => 'news.create', 'icon' => null, 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'parent_show' => $manageMediaContents->id, 'sidebar_link' => '0', 'appear' => '0']);
        $displayNews =  Permission::create(['name' => 'display_news', 'display_name'    =>  ['ar'   =>  'عرض خبر',   'en'    =>  'Display News'], 'route' => 'news', 'module' => 'news', 'as' => 'news.show', 'icon' => null, 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'parent_show' => $manageMediaContents->id, 'sidebar_link' => '0', 'appear' => '0']);
        $updateNews  =  Permission::create(['name' => 'update_news', 'display_name'     =>  ['ar'   =>  'تعديل خبر',   'en'    =>  'Edit News'], 'route' => 'news', 'module' => 'news', 'as' => 'news.edit', 'icon' => null, 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'parent_show' => $manageMediaContents->id, 'sidebar_link' => '0', 'appear' => '0']);
        $deleteNews =  Permission::create(['name'  => 'delete_news', 'display_name'     =>  ['ar'   =>  'حذف خبر',   'en'    =>  'Delete News'], 'route' => 'news', 'module' => 'news', 'as' => 'news.destroy', 'icon' => null, 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'parent_show' => $manageMediaContents->id, 'sidebar_link' => '0', 'appear' => '0']);


        // Advs
        $manageAdvs = Permission::create(['name' => 'manage_advs', 'display_name' => ['ar'  =>  'إدارة الإعلانات',    'en'    =>  'Manage Advertisements'], 'route' => 'advs', 'module' => 'advs', 'as' => 'advs.index', 'icon' => 'fab fa-adversal', 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '70',]);
        $manageAdvs->parent_show = $manageMediaContents->id;
        $manageAdvs->save();
        $showAdvs   =  Permission::create(['name'  => 'show_advs', 'display_name'       =>  ['ar'   =>  'الإعلانات',   'en'    =>  'Advertisements'], 'route' => 'advs', 'module' => 'advs', 'as' => 'advs.index', 'icon' => 'fab fa-adversal', 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'parent_show' => $manageMediaContents->id, 'sidebar_link' => '0', 'appear' => '0']);
        $createAdvs =  Permission::create(['name'  => 'create_advs', 'display_name'     =>  ['ar'   =>  'إنشاء اعلان',   'en'    =>  'Create Advertisement'], 'route' => 'advs', 'module' => 'advs', 'as' => 'advs.create', 'icon' => null, 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'parent_show' => $manageMediaContents->id, 'sidebar_link' => '0', 'appear' => '0']);
        $displayAdvs =  Permission::create(['name' => 'display_advs', 'display_name'    =>  ['ar'   =>  'عرض اعلان',   'en'    =>  'Display Advertisement'], 'route' => 'advs', 'module' => 'advs', 'as' => 'advs.show', 'icon' => null, 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'parent_show' => $manageMediaContents->id, 'sidebar_link' => '0', 'appear' => '0']);
        $updateAdvs  =  Permission::create(['name' => 'update_advs', 'display_name'     =>  ['ar'   =>  'تعديل اعلان',   'en'    =>  'Edit Advertisement'], 'route' => 'advs', 'module' => 'advs', 'as' => 'advs.edit', 'icon' => null, 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'parent_show' => $manageMediaContents->id, 'sidebar_link' => '0', 'appear' => '0']);
        $deleteAdvs =  Permission::create(['name'  => 'delete_advs', 'display_name'     =>  ['ar'   =>  'حذف اعلان',   'en'    =>  'Delete Advertisement'], 'route' => 'advs', 'module' => 'advs', 'as' => 'advs.destroy', 'icon' => null, 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'parent_show' => $manageMediaContents->id, 'sidebar_link' => '0', 'appear' => '0']);

        // Events
        $manageEvents = Permission::create(['name' => 'manage_events', 'display_name' => ['ar'  =>  'إدارة الاحداث القادمة',    'en'    =>  'Manage ُEvents'], 'route' => 'events', 'module' => 'events', 'as' => 'events.index', 'icon' => 'far fa-calendar-alt', 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '70',]);
        $manageEvents->parent_show = $manageMediaContents->id;
        $manageEvents->save();
        $showEvents   =  Permission::create(['name'  => 'show_events', 'display_name'       =>  ['ar'   =>  'الاحداث القادمة',   'en'    =>  'ُEvents'], 'route' => 'events', 'module' => 'events', 'as' => 'events.index', 'icon' => 'far fa-calendar-alt', 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'parent_show' => $manageMediaContents->id, 'sidebar_link' => '0', 'appear' => '0']);
        $createEvents =  Permission::create(['name'  => 'create_events', 'display_name'     =>  ['ar'   =>  'إنشاء حدث',   'en'    =>  'Create Event'], 'route' => 'events', 'module' => 'events', 'as' => 'events.create', 'icon' => null, 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'parent_show' => $manageMediaContents->id, 'sidebar_link' => '0', 'appear' => '0']);
        $displayEvents =  Permission::create(['name' => 'display_events', 'display_name'    =>  ['ar'   =>  'عرض حدث',   'en'    =>  'Display Event'], 'route' => 'events', 'module' => 'events', 'as' => 'events.show', 'icon' => null, 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'parent_show' => $manageMediaContents->id, 'sidebar_link' => '0', 'appear' => '0']);
        $updateEvents  =  Permission::create(['name' => 'update_events', 'display_name'     =>  ['ar'   =>  'تعديل حدث',   'en'    =>  'Edit Event'], 'route' => 'events', 'module' => 'events', 'as' => 'events.edit', 'icon' => null, 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'parent_show' => $manageMediaContents->id, 'sidebar_link' => '0', 'appear' => '0']);
        $deleteEvents =  Permission::create(['name'  => 'delete_events', 'display_name'     =>  ['ar'   =>  'حذف حدث',   'en'    =>  'Delete Event'], 'route' => 'events', 'module' => 'events', 'as' => 'events.destroy', 'icon' => null, 'parent' => $manageMediaContents->id, 'parent_original' => $manageMediaContents->id, 'parent_show' => $manageMediaContents->id, 'sidebar_link' => '0', 'appear' => '0']);


        // Multimedia
        $manageMultimedia  = Permission::create(['name' => 'manage_multimedia', 'display_name' => ['ar'  =>  'إدارة الوسائط',    'en'    =>  'Manage Multimedia'], 'route' => 'multimedia', 'module' => 'multimedia', 'as' => 'albums.index', 'icon' => 'far fa-images', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '70',]);
        $manageMultimedia->parent_show = $manageMultimedia->id;
        $manageMultimedia->save();

        // Albums
        $manageAlbums  = Permission::create(['name' => 'manage_albums', 'display_name' => ['ar'  =>  'إدارة البومات الصور',    'en'    =>  'Manage Albums'], 'route' => 'albums', 'module' => 'albums', 'as' => 'albums.index', 'icon' => 'far fa-images', 'parent' => $manageMultimedia->id, 'parent_original' => $manageMultimedia->id, 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '70',]);
        $manageAlbums->parent_show = $manageAlbums->id;
        $manageAlbums->save();
        $showAlbums   =  Permission::create(['name'  => 'show_albums', 'display_name'       =>  ['ar'   =>  'البومات الصور',   'en'    =>  'Albums'], 'route' => 'albums', 'module' => 'albums', 'as' => 'albums.index', 'icon' => 'far fa-images', 'parent' => $manageMultimedia->id, 'parent_original' => $manageMultimedia->id, 'parent_show' => $manageMultimedia->id, 'sidebar_link' => '0', 'appear' => '0']);
        $createAlbums =  Permission::create(['name'  => 'create_albums', 'display_name'     =>  ['ar'   =>  'إنشاء البوم جديد',   'en'    =>  'Create Album'], 'route' => 'albums', 'module' => 'albums', 'as' => 'albums.create', 'icon' => null, 'parent' => $manageMultimedia->id, 'parent_original' => $manageMultimedia->id, 'parent_show' => $manageMultimedia->id, 'sidebar_link' => '0', 'appear' => '0']);
        $displayAlbums =  Permission::create(['name' => 'display_albums', 'display_name'    =>  ['ar'   =>  'عرض البوم ',   'en'    =>  'Display Album'], 'route' => 'albums', 'module' => 'albums', 'as' => 'albums.show', 'icon' => null, 'parent' => $manageMultimedia->id, 'parent_original' => $manageMultimedia->id, 'parent_show' => $manageMultimedia->id, 'sidebar_link' => '0', 'appear' => '0']);
        $updateAlbums  =  Permission::create(['name' => 'update_albums', 'display_name'     =>  ['ar'   =>  'تعديل البوم',   'en'    =>  'Edit Album'], 'route' => 'albums', 'module' => 'albums', 'as' => 'albums.edit', 'icon' => null, 'parent' => $manageMultimedia->id, 'parent_original' => $manageMultimedia->id, 'parent_show' => $manageMultimedia->id, 'sidebar_link' => '0', 'appear' => '0']);
        $deleteAlbums =  Permission::create(['name'  => 'delete_albums', 'display_name'     =>  ['ar'   =>  'حذف البوم',   'en'    =>  'Delete Album'], 'route' => 'albums', 'module' => 'albums', 'as' => 'albums.destroy', 'icon' => null, 'parent' => $manageMultimedia->id, 'parent_original' => $manageMultimedia->id, 'parent_show' => $manageMultimedia->id, 'sidebar_link' => '0', 'appear' => '0']);


        // PlayLists
        $managePlayLists  = Permission::create(['name' => 'manage_playlists', 'display_name' => ['ar'  =>  'إدارة قوائم التشغيل  ',    'en'    =>  'Manage Playlists'], 'route' => 'playlists', 'module' => 'playlists', 'as' => 'playlists.index', 'icon' => 'fas fa-video', 'parent' => $manageMultimedia->id, 'parent_original' => $manageMultimedia->id, 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '70',]);
        $managePlayLists->parent_show = $managePlayLists->id;
        $managePlayLists->save();
        $showPlayLists   =  Permission::create(['name'  => 'show_playlists', 'display_name'       =>  ['ar'   =>  'قوائم التشغيل',   'en'    =>  'Playlists'], 'route' => 'playlists', 'module' => 'playlists', 'as' => 'playlists.index', 'icon' => 'fas fa-video', 'parent' => $manageMultimedia->id, 'parent_original' => $manageMultimedia->id, 'parent_show' => $manageMultimedia->id, 'sidebar_link' => '0', 'appear' => '0']);
        $createPlayLists =  Permission::create(['name'  => 'create_playlists', 'display_name'     =>  ['ar'   =>  'إنشاء قائمة تشغيل جديد',   'en'    =>  'Create Playlist'], 'route' => 'playlists', 'module' => 'playlists', 'as' => 'playlists.create', 'icon' => null, 'parent' => $manageMultimedia->id, 'parent_original' => $manageMultimedia->id, 'parent_show' => $manageMultimedia->id, 'sidebar_link' => '0', 'appear' => '0']);
        $displayPlayLists =  Permission::create(['name' => 'display_playlists', 'display_name'    =>  ['ar'   =>  'عرض قائمة تشغيل ',   'en'    =>  'Display Playlist'], 'route' => 'playlists', 'module' => 'playlists', 'as' => 'playlists.show', 'icon' => null, 'parent' => $manageMultimedia->id, 'parent_original' => $manageMultimedia->id, 'parent_show' => $manageMultimedia->id, 'sidebar_link' => '0', 'appear' => '0']);
        $updatePlayLists  =  Permission::create(['name' => 'update_playlists', 'display_name'     =>  ['ar'   =>  'تعديل قائمة تشغيل',   'en'    =>  'Edit Playlist'], 'route' => 'playlists', 'module' => 'playlists', 'as' => 'playlists.edit', 'icon' => null, 'parent' => $manageMultimedia->id, 'parent_original' => $manageMultimedia->id, 'parent_show' => $manageMultimedia->id, 'sidebar_link' => '0', 'appear' => '0']);
        $deletePlayLists =  Permission::create(['name'  => 'delete_playlists', 'display_name'     =>  ['ar'   =>  'حذف قائمة تشغيل',   'en'    =>  'Delete Playlist'], 'route' => 'playlists', 'module' => 'playlists', 'as' => 'playlists.destroy', 'icon' => null, 'parent' => $manageMultimedia->id, 'parent_original' => $manageMultimedia->id, 'parent_show' => $manageMultimedia->id, 'sidebar_link' => '0', 'appear' => '0']);
        ...
        // President Speeches
        $managePresidentSpeeches = Permission::create(['name' => 'manage_president_speeches', 'display_name' => ['ar'  =>  'إدارة الرؤية والرسالة',    'en'    =>  'Vision and Mission Management'], 'route' => 'president_speeches', 'module' => 'president_speeches', 'as' => 'president_speeches.index', 'icon' => 'fas fas fa-newspaper', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '75',]);
        $managePresidentSpeeches->parent_show = $managePresidentSpeeches->id;
        $managePresidentSpeeches->save();
        $showAboutInstatutes   =  Permission::create(['name'  => 'show_president_speeches', 'display_name'       =>  ['ar'   =>  'الرؤية والرسالة',   'en'    =>  'President Speeches'], 'route' => 'president_speeches', 'module' => 'president_speeches', 'as' => 'president_speeches.index', 'icon' => 'fas fas fa-newspaper', 'parent' => $managePresidentSpeeches->id, 'parent_original' => $managePresidentSpeeches->id, 'parent_show' => $managePresidentSpeeches->id, 'sidebar_link' => '0', 'appear' => '0']);
        $createAboutInstatutes =  Permission::create(['name'  => 'create_president_speeches', 'display_name'     =>  ['ar'   =>  'إنشاء الرؤية والرسالة',   'en'    =>  'Create President Speech'], 'route' => 'president_speeches', 'module' => 'president_speeches', 'as' => 'president_speeches.create', 'icon' => null, 'parent' => $managePresidentSpeeches->id, 'parent_original' => $managePresidentSpeeches->id, 'parent_show' => $managePresidentSpeeches->id, 'sidebar_link' => '0', 'appear' => '0']);
        $displayAboutInstatutes =  Permission::create(['name' => 'display_president_speeches', 'display_name'    =>  ['ar'   =>  'عرض الرؤية والرسالة',   'en'    =>  'Display President Speech'], 'route' => 'president_speeches', 'module' => 'president_speeches', 'as' => 'president_speeches.show', 'icon' => null, 'parent' => $managePresidentSpeeches->id, 'parent_original' => $managePresidentSpeeches->id, 'parent_show' => $managePresidentSpeeches->id, 'sidebar_link' => '0', 'appear' => '0']);
        $updateAboutInstatutes  =  Permission::create(['name' => 'update_president_speeches', 'display_name'     =>  ['ar'   =>  'تعديل الرؤية والرسالة',   'en'    =>  'Edit President Speech'], 'route' => 'president_speeches', 'module' => 'president_speeches', 'as' => 'president_speeches.edit', 'icon' => null, 'parent' => $managePresidentSpeeches->id, 'parent_original' => $managePresidentSpeeches->id, 'parent_show' => $managePresidentSpeeches->id, 'sidebar_link' => '0', 'appear' => '0']);
        $deleteAboutInstatutes =  Permission::create(['name'  => 'delete_president_speeches', 'display_name'     =>  ['ar'   =>  'حذف الرؤية والرسالة',   'en'    =>  'Delete President Speech'], 'route' => 'president_speeches', 'module' => 'president_speeches', 'as' => 'president_speeches.destroy', 'icon' => null, 'parent' => $managePresidentSpeeches->id, 'parent_original' => $managePresidentSpeeches->id, 'parent_show' => $managePresidentSpeeches->id, 'sidebar_link' => '0', 'appear' => '0']);


        // Statistics
        $manageStatistics = Permission::create(['name' => 'manage_Statistics', 'display_name' => ['ar'  =>  'إدارة الارقام والإحصائيات',    'en'    =>  'Manage Statistics'], 'route' => 'statistics', 'module' => 'statistics', 'as' => 'statistics.index', 'icon' => 'far fa-calendar-alt', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '140',]);
        $manageStatistics->parent_show = $manageStatistics->id;
        $manageStatistics->save();
        $showStatistics   =  Permission::create(['name'  => 'show_Statistics', 'display_name'       =>  ['ar'   =>  'الارقام والإحصائيات',   'en'    =>  'Statistics'], 'route' => 'statistics', 'module' => 'statistics', 'as' => 'statistics.index', 'icon' => 'far fa-calendar-alt', 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        ...
        //Topics menu
        $manageTopicsMenus = Permission::create(['name' => 'manage_topics_menus', 'display_name' => ['ar'    =>  'إدارة القائمة لجانبية', 'en'   =>  'Topics Menu'], 'route' => 'topics_menus', 'module' => 'topics_menus', 'as' => 'topics_menus.index', 'icon' => 'fas fa-bars', 'parent' => $manageMainMenus->id, 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '95',]);
        $manageTopicsMenus->parent_show = $manageTopicsMenus->id;
        $manageTopicsMenus->save();
        $showTopicsMenus    =  Permission::create(['name' => 'show_topics_menus',  'display_name' => ['ar'  =>  'إدارة القائمة لجانبية',   'en'    =>  'Topics Menu'], 'route' => 'topics_menus', 'module' => 'topics_menus', 'as' => 'topics_menus.index', 'icon' => 'fas fa-bars', 'parent' => $manageTopicsMenus->id, 'parent_original' => $manageTopicsMenus->id, 'parent_show' => $manageTopicsMenus->id, 'sidebar_link' => '1', 'appear' => '1']);
        $createTopicsMenus  =  Permission::create(['name' => 'create_topics_menus', 'display_name'  => ['ar'  =>  'إضافة قائمة جانبية',   'en'    =>  'Add Topic Menu Link'], 'route' => 'topics_menus', 'module' => 'topics_menus', 'as' => 'topics_menus.create', 'icon' => null, 'parent' => $manageTopicsMenus->id, 'parent_original' => $manageTopicsMenus->id, 'parent_show' => $manageTopicsMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        $displayTopicsMenus =  Permission::create(['name' => 'display_topics_menus', 'display_name'  => ['ar'  =>  'عرض قائمة جانبية',   'en'    =>  'Display Topic Menu Link'], 'route' => 'topics_menus', 'module' => 'topics_menus', 'as' => 'topics_menus.show', 'icon' => null, 'parent' => $manageTopicsMenus->id, 'parent_original' => $manageTopicsMenus->id, 'parent_show' => $manageTopicsMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        $updateTopicsMenus  =  Permission::create(['name' => 'update_topics_menus', 'display_name'  => ['ar'  =>  'تعديل قائمة جانبية',   'en'    =>  'Edit Topic Menu Link'], 'route' => 'topics_menus', 'module' => 'topics_menus', 'as' => 'topics_menus.edit', 'icon' => null, 'parent' => $manageTopicsMenus->id, 'parent_original' => $manageTopicsMenus->id, 'parent_show' => $manageTopicsMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        $deleteTopicsMenus  =  Permission::create(['name' => 'delete_topics_menus', 'display_name'  => ['ar'  =>  'حذف قائمة جانبية',   'en'    =>  'Delete Topic Menu Link'], 'route' => 'topics_menus', 'module' => 'topics_menus', 'as' => 'topics_menus.destroy', 'icon' => null, 'parent' => $manageTopicsMenus->id, 'parent_original' => $manageTopicsMenus->id, 'parent_show' => $manageTopicsMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        ...
        $manageSupervisors = Permission::create(['name' => 'manage_supervisors', 'display_name' => ['ar'    =>  'إدارة حسابات المستخدمين',    'en'    =>  'Manage Supervisors'], 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.index', 'icon' => 'fas fa-user-tie', 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '25',]);
        $manageSupervisors->parent_show = $manageSupervisors->id;
        $manageSupervisors->save();
        $showSupervisors   =  Permission::create(['name' => 'show_supervisors', 'display_name'    =>  ['ar'   =>  'حسابات المستخدمين',   'en'    =>  'Supervisors'], 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.index', 'icon' => 'fas fa-user-tie', 'parent' => $manageSupervisors->id, 'parent_original' => $manageSupervisors->id, 'parent_show' => $manageSupervisors->id, 'sidebar_link' => '0', 'appear' => '0']);
        $createSupervisors =  Permission::create(['name' => 'create_supervisors', 'display_name'    =>  ['ar'   =>  'إضافة مستخدم جديد',   'en'    =>  'Add Supervisor'], 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.create', 'icon' => null, 'parent' => $manageSupervisors->id, 'parent_original' => $manageSupervisors->id, 'parent_show' => $manageSupervisors->id, 'sidebar_link' => '0', 'appear' => '0']);
        $displaySupervisors =  Permission::create(['name' => 'display_supervisors', 'display_name'    =>  ['ar'   =>  'عرض مستخدم',   'en'    =>  'Dsiplay Supervisor'], 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.show', 'icon' => null, 'parent' => $manageSupervisors->id, 'parent_original' => $manageSupervisors->id, 'parent_show' => $manageSupervisors->id, 'sidebar_link' => '0', 'appear' => '0']);
        $updateSupervisors  =  Permission::create(['name' => 'update_supervisors', 'display_name'    =>  ['ar'   =>  'تعديل مستخدم',   'en'    =>  'Edit Supervisor'], 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.edit', 'icon' => null, 'parent' => $manageSupervisors->id, 'parent_original' => $manageSupervisors->id, 'parent_show' => $manageSupervisors->id, 'sidebar_link' => '0', 'appear' => '0']);
        $deleteSupervisors =  Permission::create(['name' => 'delete_supervisors', 'display_name'    =>  ['ar'   =>  'حذف مستخدم',   'en'    =>  'Delete Supervisor'], 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.destroy', 'icon' => null, 'parent' => $manageSupervisors->id, 'parent_original' => $manageSupervisors->id, 'parent_show' => $manageSupervisors->id, 'sidebar_link' => '0', 'appear' => '0']);
