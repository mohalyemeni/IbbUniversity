                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="content" role="tabpanel" aria-labelledby="content-tab">
                            ...
                            @foreach (config('locales.languages') as $key => $val)
                                <div class="row ">
                                    ...
                                    <div class="col-sm-12 col-md-9 pt-3">
                                        <textarea id="tinymceExample" name="description[{{ $key }}]" rows="10" class="form-control ">{!! old('description.' . $key, $tracksMenu->getTranslation('description', $key)) !!}</textarea>
                                ...
                                <div class="col-sm-12 col-md-9 pt-3">
                                    <div class="input-group iconpicker-container ">
                                        <input data-placement="bottomRight"
                                            ...
                                            value=" {{ old('icon', $tracksMenu->icon) ?? 'fas fa-archive' }}"
                                            type="text" name="icon">
                                        <span class="input-group-addon btn btn-primary">
                                            <i class="{{ $tracksMenu->icon ?? 'fas fa-archive' }}"></i>
                                        </span>
                                    </div>
                                    @error('icon')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-sm-12 col-md-9 pt-3">
                                    <div class="input-group flatpickr" id="flatpickr-datetime">
                                        <input type="text" name="published_on" class="form-control"
                                            ...
                                            value="{{ old('published_on', $tracksMenu->published_on ? \Carbon\Carbon::parse($tracksMenu->published_on)->format('Y/m/d h:i A') : '') }}">
                                ...
                                <div class="col-sm-12 col-md-9 pt-3">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" class="form-check-input" name="status" id="status_active"
                                            value="1"
                                            {{ old('status', $tracksMenu->status) == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" class="form-check-input" name="status"
                                            ...
                                            {{ old('status', $tracksMenu->status) == '0' ? 'checked' : '' }}>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-9 pt-3">
                                        <input type="text" name="metadata_title[{{ $key }}]"
                                            ...
                                            value="{{ old('metadata_title.' . $key, $tracksMenu->getTranslation('metadata_title', $key)) }}"
                                            class="form-control">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-9 pt-3">
                                        <input type="text" name="metadata_description[{{ $key }}]"
                                            ...
                                            value="{{ old('metadata_description.' . $key, $tracksMenu->getTranslation('metadata_description', $key)) }}"
                                            class="form-control">
                                            ...
                                            <div class="card-body">
                                                <div>
                                                    <input name="metadata_keywords[{{ $key }}]"
                                                        ...
                                                        value="{{ old('metadata_keywords.' . $key, $tracksMenu->getTranslation('metadata_keywords', $key)) }}" />
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-9 pt-3">
                                ...
                                <a href="{{ route('admin.tracks_menus.index') }}" name="submit"
