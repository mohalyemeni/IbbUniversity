    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="card-naving">
                <h3 class="font-weight-bold text-primary">
                    ...
                    {{ __('panel.edit_existing_contact_us_menu_item') }}
                </h3>
                <ul class="breadcrumb pt-3">
                    ...
                    <li class="ms-1">
                        <a href="{{ route('admin.contact_us_menus.index') }}">
        ...
        <div class="card-body">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.contact_us_menus.update', $contactUsMenu->id) }}" method="post">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="content" role="tabpanel" aria-labelledby="content-tab">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-sm-12 col-md-9 pt-3">
                                        <input type="text" name="title[{{ $key }}]"
                                            id="title[{{ $key }}]"
                                            value="{{ old('title.' . $key, $contactUsMenu->getTranslation('title', $key)) }}"
                                            class="form-control">
                                        @error('title.' . $key)
                            ...
                            @foreach (config('locales.languages') as $key => $val)
                                <div class="row ">
                                    ...
                                    <div class="col-sm-12 col-md-9 pt-3">
                                        <textarea id="tinymceExample" name="description[{{ $key }}]" rows="10" class="form-control ">{!! old('description.' . $key, $contactUsMenu->getTranslation('description', $key)) !!}</textarea>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-sm-12 col-md-9 pt-3">
                                        <input type="text" name="link[{{ $key }}]"
                                            id="link[{{ $key }}]"
                                            value="{{ old('link.' . $key, $contactUsMenu->getTranslation('link', $key)) }}"
                                            class="form-control">
                                        @error('link.' . $key)
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-sm-12 col-md-9 pt-3">
                                    <div class="input-group iconpicker-container ">
                                        <input data-placement="bottomRight"
                                            ...
                                            value=" {{ old('icon', $contactUsMenu->icon) ?? 'fas fa-archive' }}"
                                            type="text" name="icon">
                                        <span class="input-group-addon btn btn-primary">
                                            <i class="{{ $contactUsMenu->icon ?? 'fas fa-archive' }}"></i>
                                        </span>
                                    </div>
                                    @error('icon')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-sm-12 col-md-9 pt-3">
                                    <div class="input-group flatpickr" id="flatpickr-datetime">
                                        <input type="text" name="published_on" class="form-control"
                                            ...
                                            value="{{ old('published_on', $contactUsMenu->published_on ? \Carbon\Carbon::parse($contactUsMenu->published_on)->format('Y/m/d h:i A') : '') }}">
                                ...
                                <div class="col-sm-12 col-md-9 pt-3">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" class="form-check-input" name="status" id="status_active"
                                            value="1"
                                            {{ old('status', $contactUsMenu->status) == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" class="form-check-input" name="status"
                                            ...
                                            {{ old('status', $contactUsMenu->status) == '0' ? 'checked' : '' }}>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-9 pt-3">
                                        <input type="text" name="metadata_title[{{ $key }}]"
                                            ...
                                            value="{{ old('metadata_title.' . $key, $contactUsMenu->getTranslation('metadata_title', $key)) }}"
                                            class="form-control">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-9 pt-3">
                                        <input type="text" name="metadata_description[{{ $key }}]"
                                            ...
                                            value="{{ old('metadata_description.' . $key, $contactUsMenu->getTranslation('metadata_description', $key)) }}"
                                            class="form-control">
                                            ...
                                            <div class="card-body">
                                                <div>
                                                    <input name="metadata_keywords[{{ $key }}]"
                                                        ...
                                                        value="{{ old('metadata_keywords.' . $key, $contactUsMenu->getTranslation('metadata_keywords', $key)) }}" />
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-9 pt-3">
                                ...
                                <a href="{{ route('admin.contact_us_menus.index') }}" name="submit"
