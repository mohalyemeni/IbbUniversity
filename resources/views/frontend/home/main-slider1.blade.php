...
<div class="rs-slider style1 ">
    <div class="rs-carousel owl-carousel" data-loop="true" data-items="1" data-margin="0" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="false" data-nav-speed="false" data-center-mode="true" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="1" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="1" data-ipad-device-nav2="true" data-ipad-device-dots2="false" data-md-device="1" data-md-device-nav="true" data-md-device-dots="false">
        @forelse ($main_sliders->where('section' ,1) as $main_slider)
            ...
            @endphp
            <div class="slider-content slide{{ ++$loop->index }}" style="background-image: url({{ $main_slider_img }}) !important">
                <div class="container">
                    <div class="content-part">
                        @if ($main_slider->show_info)
                            ...
                            <h1 class="sl-title wow fadeInCenter text-white text-center" data-wow-delay="600ms" data-wow-duration="2000ms">
                                {{ $main_slider->title }}
                            </h1>
                        @endif
